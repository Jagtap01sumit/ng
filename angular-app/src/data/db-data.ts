export const COURSES: any = [
    ...
    },
    {
        ...
        longDescription: "Learn the principles of user experience and interface design, wireframing, prototyping, and the tools needed to build intuitive digital products.",
    ...
    },
    {
        ...
        longDescription: "A beginner-friendly course to learn the core concepts of React, including JSX, components, state, props, and hooks through hands-on examples.",
        url: "https://cdn.pixabay.com/photo/2019/07/11/15/34/luck-4330900_1280.jpg",
